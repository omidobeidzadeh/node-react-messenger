          ...
          <li>
            ...
            >
              ...
              <svg
                ...
                height="24"
                viewBox="0 0 24 24"
                className="eva eva-arrow-ios-forward"
              >
                <g data-name="Layer 2">
              ...
              <svg
                ...
                height="24"
                viewBox="0 0 24 24"
                className="eva eva-arrow-ios-downward"
              >
                <g data-name="Layer 2">
              ...
              <div className="inside">
                <ul className="options">
                  <li>
                    ...
                    <p>
                      می توانید تنظیم کنید کسی آنلاین بودن شما را ببیند یا خیر
                    </p>
                  </li>
                  <li>
                    <div className="headline">
                    ...
                    <p>
                      می توانید تنظیم کنید تاریخچه ها تا چه زمانی در دسترس
                      باشند.
                    </p>
                  </li>
                  <li>
              ...
              <div className="inside">
                <ul className="options">
                  <li>
                    ...
                    <p>
                      می توانید تنظیم کنید پیام ها روی صفحه ظاهر شوند یا خیر/
                    </p>
                  </li>
                  <li>
                    <div className="headline">
                    ...
                    <p>
                      می توانید تعیین کنید در هنگام پیام صفحه لرزش داشته باشد یا
                      خیر
                    </p>
                  </li>
                  <li>
              ...
              <div className="inside">
                <ul className="options">
                  <li>
                    ...
                    <p>
                      با استفاده از این مورد می توانید حالت شب را فعال یا غیر
                      فعال کنید
                    </p>
                  </li>
                </ul>
